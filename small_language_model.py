...
Original file is located at
    https://colab.research.google.com/drive/1dw_Bg4Cu8omnu6syfVBrS8zr_QHwNj0e

# Introduction

Small Language Model with parameter size 10-15 million.

## Step 1: Import the Dataset

TinyStories a synthetic dataset for short stories (ages group 3 to 4 years) via Hugging Face, Generated by GTP 3.5.
"""
